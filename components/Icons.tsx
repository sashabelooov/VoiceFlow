...
export const StarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.563.044.793.774.362 1.12l-4.162 3.32a.563.563 0 00-.172.527l1.228 5.345a.562.562 0 01-.83.655l-4.634-2.877a.562.562 0 00-.586 0l-4.634 2.877a.562.562 0 01-.83-.655l1.228-5.345a.563.563 0 00-.172-.527l-4.162-3.32c-.431-.346-.201-1.076.362-1.12l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
  </svg>
);
